...
const selectElement = (selector) =>
{
    ...
    if (element) return element; //if element=true
    throw new Error (`Sth went wrong. Make sure that ${selector} exists or is typed correctly.`);
};
